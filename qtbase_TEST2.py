...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gb_degree.setGeometry(QtCore.QRect(10, 130, 241, 81))
        self.gb_degree.setObjectName("gb_degree")
        self.formLayoutWidget_2 = QtWidgets.QWidget(self.gb_degree)
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(10, 20, 211, 53))
        ...
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(10, 70, 441, 51))
        ...
        self.rb_degree = QtWidgets.QRadioButton(self.formLayoutWidget_3)
        self.rb_degree.setAcceptDrops(False)
        self.rb_degree.setChecked(True)
        self.rb_degree.setObjectName("rb_degree")
        self.flout_nameandtype.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.rb_degree)
        self.rb_utm = QtWidgets.QRadioButton(self.formLayoutWidget_3)
        self.rb_utm.setObjectName("rb_utm")
        self.flout_nameandtype.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.rb_utm)
        self.lbl_name = QtWidgets.QLabel(self.formLayoutWidget_3)
        self.lbl_name.setEnabled(True)
        self.lbl_name.setScaledContents(False)
        ...
        self.gb_spec.setGeometry(QtCore.QRect(260, 130, 191, 81))
        self.gb_spec.setObjectName("gb_spec")
        self.formLayoutWidget_4 = QtWidgets.QWidget(self.gb_spec)
        self.formLayoutWidget_4.setGeometry(QtCore.QRect(10, 20, 160, 53))
    ...
    def retranslateUi(self, Form):
        ...
        self.rb_degree.setText(_translate("Form", "Decimal Degree"))
        self.rb_utm.setText(_translate("Form", "Universal Transverse Marcetor (UTM)"))
        self.lbl_name.setText(_translate("Form", "Name of Point  (without etension)"))
